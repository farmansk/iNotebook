...
const Noteitem = (props) => {
    ...
    return (
        <>
            <button type="button" id="deletelaunchbtn" ref={deleteref} className="btn btn-primary d-none" data-bs-toggle="modal" data-bs-target="#staticBackdropdelete">
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="staticBackdropLabeldelete">Delete Note</h5>
