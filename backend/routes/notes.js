...
// ROUTE 3: Update an existing Note using: PUT "/api/notes/updatenote". Requires auth
...
// ROUTE 4: Delete an existing Note using: DELETE "/api/notes/deletenote". Requires auth
